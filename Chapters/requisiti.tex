...
I casi d'uso\marginpar{Codifica casi d'uso} utilizzati per la progettazione dei prototipi hanno un codice identificativo univoco, nella forma:
\begin{center}
...
I requisiti\marginpar{Codifica requisiti} vengono individuati dall'analisi effettuata sulle richieste dell'azienda, oppure emergono dai casi d'uso o nascono da esigenze interne; sono classificati per tipo e importanza secondo la seguente codifica:
\begin{center}
