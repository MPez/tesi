...
\item[descrizione]: \hfill
	...
	\item Il sistema effettua il salvataggio sulla memoria di massa del dispositivo in un file di testo chiamato \code{backupPersonalInfo.txt} e situato nella cartella \code{SensorDevice}.
	\end{itemize}
